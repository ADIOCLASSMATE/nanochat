...
export NANOCHAT_BASE_DIR="${NANOCHAT_BASE_DIR:-$(dirname "$SCRIPT_DIR")/public/project/nanochat}"
export HF_HOME="${HF_HOME:-$(dirname "$SCRIPT_DIR")/public/.cache/huggingface}"
